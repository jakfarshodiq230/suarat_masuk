					 ...
					 <tr>
					 	<?php if ($warna=='BELUM DISPOSISI'){
							  ...
							  <td align="Right">  
								...
								<?php }else {  ?>
									<a href="../admin/cetak/cetak_disposisi.php?kode_disposisi=<?php echo "$row[kode_disposisi]" ?>" class="btn btn-info btn-xs"><span class="glyphicon glyphicon-print"></span> </a>
								<?php } ?>
