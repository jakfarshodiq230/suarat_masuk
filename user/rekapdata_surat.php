...
<div class="content-wrapper">
			...
			<section class="content-header">
				<h1 class="font">Rekap</h1>
					<ol class="breadcrumb" >
						<li class="font"><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
						<li class="active" class="font">Rekap</li>
					</ol>
			</section>
                ...
                <div class="col-lg-12" >
                    <div class="panel panel-success">
                        <div class="panel-heading" >
						 ...
						 <div >
						 <h3 align="center" class="font1">Data Surat Masuk dan Surat Keluar<h3>
                        </div>
                        <!-- /.panel-heading -->
                        <div class="box-body">
