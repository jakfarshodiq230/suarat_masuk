...
.style1 {font-size:28px
 ...
 <p align="center"  class="style4">DATA SURAT MASUK </p>
...
<tr class="head">
    ...
    <td align='center' width="212" ><span class="style5">NO. SURAT</span></td>
    <td align='center' width="296"><span class="style5">HAL</span></td>
    <td align='center' width="267"><span class="style5">ALAMAT PENGIRIM</span></td>
    <td align='center' width="92"><p class="style5">TANGGAL</p><p class="style5">SURAT</p></td>
    <td align='center' width="112"><p class="style5">TINGKAT</p><p class="style5"> KERAHASIAAN</p></td>
    <td align='center' width="79"><span class="style5">KKA</span></td>
</tr>
</thead>
<?php
...
$a=$_POST['bulan'];
$b=$_POST['tahun'];
$tampil = "select * from surat_keluar where month(tgl_surat)='$a' &&  year(tgl_surat)='$b'"; 
...
<tr  style="font-size: 12px">
    ...
    <td align='center'><span class="style7"><?php echo "$row[no_surat]";?></span></td>
    <td align='center'><span class="style7"><?php echo "$row[hal]";?></span></td>
    <td align='center'><span class="style7"><?php echo "$row[almt_pengirim]";?></span></td>
    <td align='center' ><span class="style7"><?php $ttt = $row['tgl_surat']; echo date("d-m-Y", strtotime($ttt))?></span></td>
    <td align='center' ><span class="style7"><?php echo "$row[tgkt_kerahasiaan]";?></span></td>
    <td align='center' ><span class="style7"><?php echo "$row[kka]";?></span></td>
</tr>
