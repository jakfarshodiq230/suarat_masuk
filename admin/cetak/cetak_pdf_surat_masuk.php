...
$a=$_POST['bulan'];
$b=$_POST['tahun'];
$tampil = "select * from surat_masuk where month(tgl_surat)='$a' &&  year(tgl_surat)='$b'"; 
...
<tr  style="font-size: 12px">
    ...
    <td align='justify'><span class="style7"><?php echo "$row[hal]";?></span></td>
