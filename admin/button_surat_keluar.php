        ...
        <div class="modal-dialog">
            <div class="modal-content" style="border: 1px solid  #FFF5EE;">
                <div class="modal-header" style="background-color: #FF6347;">
                    ...
                    <center><h4 class="modal-title" id="myModalLabel"><strong>Hapus</strong></h4></center>
                </div>
                <div class="modal-body">
				<?php
				 include"../koneksi/koneksi.php"; //untuk memanggil koneksi
					$del=mysql_query("select * from surat_keluar where no_agenda='".$row['no_agenda']."'");
                ...
                <div class="modal-footer">
                    ...
                    <a href="delete_surat_keluar.php?id=<?php echo $row['no_agenda']; ?>" class="btn btn-danger"><span class="glyphicon glyphicon-trash"></span>Hapus</a>
                </div>
 ...
 <div class="modal fade" id="edit<?php echo $row['no_agenda']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content" style="border: 1px solid  #FFF5EE;">
				...
				<?php
				   include"../koneksi/koneksi.php"; //untuk memanggil koneksi
					$edit=mysql_query("select * from surat_keluar where no_agenda ='".$row['no_agenda']."'");
					$erow=mysql_fetch_array($edit);
				?>
                <div class="modal-body">
				<div class="container-fluid">
				<form method="POST" action="edit_surat_keluar.php?id=<?php echo $erow['no_agenda']; ?>"> <!--query simpan-->
					...
					<div style="height:10px;"></div>
						<div class="row">
							...
							<div class="col-lg-8">
								<textarea class="form-control"  name="hal"  style="width: 100%;""><?php echo $erow['hal']; ?></textarea>
							</div>
						</div>
					...
					<div style="height:10px;"></div>
						<div class="row">
							...
							<div class="col-lg-8">
								<textarea class="form-control"  name="alamat_tujuan"  style="width: 100%;""><?php echo $erow['almt_tujuan']; ?></textarea>
							</div>
						</div>
				...
				<div class='col-md-15'>
					<div class='panel'>
						<div class='panel-heading'>
		                   		 <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
		                    	<center><h4 class="modal-title" id="myModalLabel"><strong>Surat Keluar</strong></h4></center>
						</div>
