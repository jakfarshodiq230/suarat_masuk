            ...
            <div class="col-lg-12" >
                <div class="panel panel-success">
                        <div class="panel-heading" >
                            <span class="block-heading icon-bookmark" class="font1">Data Surat Masuk</span>
                        </div >
					<!-- /.box-header -->
					<div class="box-body">
					...
					<!-- masuk-->
							<section class="content-header" >
									...
									<table id="example1" class="table table-bordered table-striped">
										<thead>
											<tr>
												...
												<th align="center">KKA</th>
													...
													<?php
															...
															$query=mysql_query("SELECT * from surat_masuk GROUP BY tgl_penerimaan DESC ");
															$nomor=1;
											...
											<tr>
												...
												<td><?php echo "$row[almt_pengirim]"?></td>
									...
									<?php include('add_modal_laporan_surat_masuk.php'); ?> 
					<!-- /masuk -->	
					</div>
				</div>
			</div>
