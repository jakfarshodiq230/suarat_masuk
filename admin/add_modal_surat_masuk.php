        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <center><h4 class="modal-title" id="myModalLabel">Surat Masuk</h4></center>
                </div>
                <div class="modal-body">
				<div class="container-fluid">
				<form method="POST" action="addnew_surat_masuk.php" enctype="multipart/form-data"> <!--query simpan-->
					<div class="row">
						<div class="col-lg-2">
					...
					<div class="row">
						...
						<div class="col-lg-2"><label>Tanggal Penerimaan</label></div>
								<div class="col-lg-6"><div  class="input-group">
									<div class="input-group-addon">
										<i class="fa fa-calendar"></i>
									</div>
										<input name="tgl2" id="tgl" class="form-control" READONLY value="<?php echo$tanggal ?> ">
								</div></div>
									<!-- /.input group -->
					</div> 
					<div style="height:10px;"></div>
					...
					<div class="row">
						...
						<div class="col-lg-10">
							<textarea class="form-control"  name="almt_pengirim" placeholder="nama intansi" required oninvalid="this.setCustomValidity('data tidak boleh kosong')" oninput="setCustomValidity('')"></textarea>
						</div>
					</div>
					<div style="height:10px;"></div>
					<div class="row">
