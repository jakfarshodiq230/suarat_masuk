	...
	<div class="wrapper">
		...
		<header class="main-header">
			...
			<nav class="navbar navbar-static-top">
				...
				$query = $koneksi->query("select * from user where username =  '" . $_SESSION['user'] . "'");
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				<h1 class="font">Branda</h1>
				<ol class="breadcrumb">
					<li class="font"><a href="#"><i class="fa fa-dashboard"></i> Branda</a></li>
					<li class="active" class="font">Branda</li>
				</ol>
			</section>
			...
			<section class="content">
				...
				<div class="row">
					...
					<?php
					include "../koneksi/koneksi.php";
					$sql = "SELECT count(*) AS jumlah FROM surat_masuk";
					$query = mysqli_query($koneksi, $sql);
					$row = mysqli_fetch_array($query);
					?>
					<div class="col-lg-4 ">
					...
					<?php
					include "../koneksi/koneksi.php";
					$sql = "SELECT count(*) AS jumlah FROM surat_keluar";
					$query = mysqli_query($koneksi, $sql);
					$row = mysqli_fetch_array($query);
					?>
					<div class="col-lg-4 ">
