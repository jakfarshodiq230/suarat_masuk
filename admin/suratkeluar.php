...
<body class="hold-transition skin-blue ">
  ...
  <!-- Content Wrapper. Contains page content -->
	...
	<section class="content">
		<div class="row">
                <div class="col-lg-12" >
                    <div class="panel panel-success">
                        <div class="panel-heading" >
                            <span class="block-heading icon-bookmark">Arsip Surat Keluar</span>
                        </div >
						<div >
						 <h3 align="center" class="font1">Data Surat Keluar<h3>
                        </div>
					<div class="box-header">
						<span  class="pull-right" ><a href="#addnew" data-toggle="modal" class="btn btn-success btn-md"><span class="glyphicon glyphicon-plus" style="font-size: 15px;"> Surat Keluar</span></a></span>
					</div>
            <!-- /.box-header -->
            <div class="box-body">
            <div class="table-responsive">
					 ...
					 <tr>
							  ...
							  <td align="justify"><?php echo "$row[almt_tujuan]" ?></td>
							  <td align="justify"><?php $ttt = $row['tgl_surat']; echo date("d-m-Y", strtotime($ttt))?></td>
							  <td align="center"><?php echo "$row[tgkt_kerahasiaan]" ?></td>
							  <td align="center"><?php echo "$row[kka]" ?></td>
							<td align="right">  <div class="btn-group-harizontal">
							 <a href="#edit<?php echo $row['no_agenda']; ?>" data-toggle="modal" class="btn btn-warning btn-xs"><span  class="glyphicon glyphicon-edit"></span> </a>
							    ...
							    <a href="#view<?php echo $row['no_agenda']; ?>" data-toggle="modal" class="btn btn-info btn-xs"><span class="glyphicon glyphicon-eye-open"></span> </a> </div>
			                      <?php include('button_surat_keluar.php'); ?>							
	                         </td> 
					</tr> 
					<?php
					$nomor++;
	 ...
	 <?php include('add_modal_surat_keluar.php'); ?> 
	</section>
    <!-- /.box-body -->
    </div>
